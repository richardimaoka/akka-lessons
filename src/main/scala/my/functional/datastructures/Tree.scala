...
object TreeTest {
  ...
  def foldTest: Unit = {
    println(fold(Leaf(1))(_ * 2)(_ + _))
    println()

    val a = Branch( Leaf(1), Leaf(2))
    val b = Branch( Leaf(1), Branch(Leaf(2),Leaf(2)))
    val c = Branch( Leaf(1), Branch(Leaf(2),Branch(Leaf(2),Leaf(2))))

    println(fold(a)(_ * 2)(_ + _))
    println()
    println(fold(b)(_ * 3)(_ + _))
    println()
    println(fold(c)(_ * 2)(_ + _))
    println()
  }
