...
object LocalSingletonProxySettings {
  def apply(
...
final class LocalSingletonProxySettings(
...
final class LocalSingletonProxy(
                                             singletonManagerPath: String,
                                             settings:             LocalSingletonProxySettings
  ...
  override def receive: Receive = {
    ...
    case msg: Any ⇒ {
      println(s"LocalSingletonProxy: received msg = ${msg}")
      singleton match {
        case Some(s) ⇒
//          log.info(
